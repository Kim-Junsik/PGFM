...
Provenance: supplied by the user as the metric code used alongside scDFM. Every
function below is theirs; the only thing added is this docstring. Do not "improve"
anything here - the point is that our numbers come out of the same arithmetic as
theirs, so any edit destroys the comparison. Fixes belong in the driver
(scripts/eval_scdfm_style.py), never in this file.
